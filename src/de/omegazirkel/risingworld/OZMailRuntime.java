...
import de.omegazirkel.risingworld.OZMail.Recipient;
...
class OZMailRuntime extends Plugin {
    static final String COMMAND = "ozmail";
    ...
    public void onEnable() {
        ...
        PluginInfoStatusProviders.registerProvider(new MailPluginInfoStatusProvider((OZMail) this));
        PlayerPluginSettingsOverlay.registerPlayerPluginSettings(new MailPlayerPluginSettings((OZMail) this));
        PlayerPluginSettingsOverlay.registerPlayerPluginData(new MailPlayerPluginData((OZMail) this));
